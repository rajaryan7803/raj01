            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="<?=base_url('Admin/Art');?>" class="btn btn-primary">Create</a>
                </div>
              </div>
              <div class="card-body">
                <table class="table">
                  ...
                  <tr> 
                    <td><?php echo $num++;?></td>
                    <td><?php echo $ele['title'];?></td>
                    <td><?php echo $ele['description'];?></td>
                 
                    
                    <td><img src="<?= base_url('upload/'.$ele['file_name'])?>" class="thumbnail" onclick="enlargeImage(this)"height="30px" width="20px"></td>
                    <td><?php echo $ele['author'];?></td>
                    <td><?php echo $ele['created_at'];?></td>
                    ...
                    <td>
                      <a href="<?php echo base_url('Admin/EditControllers/'.$ele['id']); ?>" class="btn btn-primary btn-sm">
                        <i class="fa fa-edit"></i>Edit
                      </a>
                      <a href="<?php echo base_url('Admin/Deletecontrollers/'.$ele['id']); ?>" class="btn btn-danger btn-sm">
