        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <?php if(count($element)):?>
                <?php foreach($element as $ele):?>
              <div class="card-body">
                <form action="<?php echo base_url('Admin/UpdateControllers');?>" method="post" enctype="multipart/form-data">
                 <input type="hidden" value="<?= $ele['id'];?>" name="id"> 
                   

                 <div class="form-group">
                    <label>Tittle</label><br>
                    <input type="text" name="title" id="title" value="<?= $ele['title'];?>">
     ...
     <section class="content">
        ...
        <div class="col-md-12">
          <div class="card card-outline card-info">
            ...
            <div class="card-body pad">
              <div class="mb-3">
                <textarea class="textarea"  type="description" name="description" id="title" value="<?= $ele['description'];?>" placeholder="Place some text here"
      ...
      <!-- ./row -->
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="file_name" id="file_name" value="<?= $ele['file_name'];?>" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="author" id="author" value="<?= $ele['author'];?>">
                    <?php echo form_error('author', '<div class="error">', '</div>'); ?>
                </div>
                
                <div class="form-group">
                    <label>Created</label><br>
                    <input type="text" name="created_at" id="created" value="<?= $ele['created_at'];?>">
