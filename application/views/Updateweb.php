          ...
          <div class="col-lg-12">
            <div class="card card-primary">
              <div class="card-header">
                ...
                <div class="card-body">
                    <form action="<?=base_url('Admin/UpdateController');?>" method="post" enctype="multipart/form-data">
                 ...
                 <div class="form-group">
                    ...
                    <input type="file" name="file_name" id="file_name"  value="<?= $table['file_name'];?>" required>
                </div>

                <div class="custom-control custom-radio float-left">
                    <input class="custom-control-input" value="1" class="form-control" type="radio" id="statusActive" name="status">
                    <label for="statusActive" class="custom-control-label">Active</label>
                   
                </div>

                <div class="custom-control custom-radio float-left">
                    <input class="custom-control-input" value="0" class="form-control" type="radio" id="statusBlock" name="status">
